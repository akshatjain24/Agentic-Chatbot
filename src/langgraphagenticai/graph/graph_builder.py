...
from src.langgraphagenticai.tools.search_tool import create_tools_node, get_tools
...
class GraphBuilder:
    ...
    def basic_chatbot_build_graph(self):
        ...
        This methpd initializes a chatbot node using the "BasicChatbotNode" class
    ...
    def chatbot_with_tools_build_graph(self):
        ...
        It defines tools, initializes the chatbot with tool capabilities, and sets up conditional and direct edges
